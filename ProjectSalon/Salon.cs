...
namespace ProjectSalon
{
    public class Salon
    {
        ...
        public Record addRecord(DateTime date, Service service, Master master, Client client)
        {
            Record newRecord = new Record(date, service, master, client);
        ...
        public bool checkClientRegistration(int number)
        {
